...
#define EOG_CONF_UI_BOXTOOL				"boxtool"
...
#define EOG_CONF_UI_IMAGE_GALLERY_THUMB_SIZE 		"image-gallery-thumb-size"
#define EOG_CONF_UI_IMAGE_GALLERY_THUMB_ADD_FRAME	"image-gallery-thumb-add-frame"
